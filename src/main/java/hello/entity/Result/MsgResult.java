...
public class MsgResult extends Result {
    String msg;
    protected MsgResult(ResultStatus status, String msg) {
        super(status);
        this.msg = msg;
    }

    public static MsgResult failure(String msg) {
        return new MsgResult(ResultStatus.FAIL,msg);
    }

    public static MsgResult failure(Exception e){
        return new MsgResult(ResultStatus.FAIL,e.getMessage());
    }

    public static MsgResult success(String msg) {
        return new MsgResult(ResultStatus.OK,msg);
    }
